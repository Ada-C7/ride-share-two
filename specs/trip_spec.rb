...
describe "RideShare::Trip" do
  ...
  describe "Trip#by_rider(rider_id)" do
    ...
    it "each returned element is a trip instances" do
      ...
      rider_id = 54
      rider_trips = RideShare::Trip.by_rider(rider_id)
      rider_trips.each { |element| element.must_be_instance_of RideShare::Trip }
    end
  ...
  describe "Trip#by_driver(driver_id)" do
    ...
    it "each returned element is a trip instances" do
      ...
      driver_id = 61
      driver_trips = RideShare::Trip.by_driver(driver_id)
      driver_trips.each { |element| element.must_be_instance_of RideShare::Trip }
    end
  ...
  describe "Trip#find_driver" do
    ...
    it "returns correct instance of driver by driver_id" do
      ...
      RideShare::Driver.all
      trip_driver = ride.find_driver
      expected_value = RideShare::Driver.find("83")
  ...
  describe "Trip#find_rider" do
    ...
    it "returns correct instance of driver by driver_id" do
      ...
      ride = RideShare::Trip.new({id: "13", driver_id: "83",rider_id: "298", date: "2015-05-27", rating: "5"})
      trip_rider = ride.find_rider
      expected_value = RideShare::Rider.find("298")
